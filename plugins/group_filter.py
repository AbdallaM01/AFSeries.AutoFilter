...
async def next_page(bot, query):
    ...
    btn.insert(11, [InlineKeyboardButton("🚀Send All🚀", callback_data=f"{allreq}_{req}_{key}_{n_offset}")])
...
async def auto_filter(client, msg, spoll=False):
    ...
    allreq = 'allfilep' if settings['file_secure'] else 'allfile'
    btn.insert(11, [InlineKeyboardButton("🚀Send All🚀", callback_data=f"{allreq}_{req}_{key}_{offset}")])
