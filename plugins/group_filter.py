...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("𝟷 اذا كنت تبحث عن مسلسل او فيلم تأكد كتابة الاسم الصحيح تستطيع الذهاب الي جوجل للتأكد من الاسم الصحيح\n𝟸 لسهولة البحث عن <b>مسلسل<b/> استخدم  👈<b>S01E01</b>بدون فواصل واضافة 0\n<b>S01 يعني الموسم الاول\nE01 يعني الحلقة الاولي</b>\n𝟹⁩ <b>لسهولة البحث عن فيلم اكتب التاريخ</b>\n𝟺 بامكانك ايضا كتابة الجودة و x265 او x264\nx265 يعني حجم اقل بنفس الجودة\nx264 يعني حجم اعلي بنفس الجودة")
    ...
    await msg.reply(" كنت تبحث عن مسلسل او فيلم تأكد كتابة الاسم صحيح تستطيع الذهاب الي جوجل للتأكد من الاسم الصحيح\nاستخدم التنسيق لسهولة البحث عن مسلسل S01E01\nS01 يعني الموسم الاول\nE01 يعني الحلقة الاولي\nاكتب التاريخ لسهولة البحث عن فيلم\nبامكانك ايضا اضافة الجودة و x265 او x264\nx265 يعني حجم اقل مع الحفاظ علي الجودة \nx264 نفس الجودة ولكن حجم اعلي",
                    reply_markup=InlineKeyboardMarkup("🔎 𝖦𝗈𝗈𝗀𝗅𝖾", url=f"https://www.google.com/search?q={reqst_gle}")
